...
https://www.cs.drexel.edu/~kschmidt/CS265/Assignments/Java-Calc/
	In short, this will take a text file with expressions and evaluate with
	infix to postfix method. For more detailed information, read the
	instruction provided above.

	

	Note for myself: I built this on Eclipse and when I converted here at PuTTy, it
	kept crashed throw errors. So, I made major changes. 
	
	I played around to fix the problem but I can't seem to find a solution.
...
public class infix2postfix{
	...
	//throw error implementing Eclipse to Putty for opType. Made constant
		...
		try{
			...
			while ((line = bufferedReader.readLine()) != null) {
				...
				System.out.println("Evalute: \t" +
						converter.infixToPostfix(line)+ "=" +
						converter.infixToPostfix(infixed));
			}
			fileReader.close();
		}catch(IOException e){
			e.printStackTrace();
